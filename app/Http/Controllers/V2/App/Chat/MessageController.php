<?php
namespace App\Http\Controllers\V2\App\Chat;
...
use App\Http\Requests\V2\App\Chat\NewChatMessageRequest;
use App\Http\Requests\V2\App\Chat\UpdateChatMessageRequest;
