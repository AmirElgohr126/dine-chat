<?php
namespace App\Http\Controllers\V2\Dashboards\DashboardAdmin\PublicPlaces\PublicPlaces;
...
use App\Http\Resources\V2\DashboardAdmin\PublicPlaces\PublicPlaceResource;
