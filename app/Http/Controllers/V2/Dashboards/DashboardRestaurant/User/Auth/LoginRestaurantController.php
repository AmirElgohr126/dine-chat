<?php
namespace App\Http\Controllers\V2\Dashboards\DashboardRestaurant\User\Auth;

use Exception;
use Illuminate\Http\Request;
use App\Models\RestaurantUser;
use App\Http\Controllers\Controller;
use App\Http\Requests\V2\Dashboard\Auth\LoginRestaurantRequest;
use App\Http\Resources\V2\DashboardAdmin\Auth\UserRestaurantDashboardResources;
