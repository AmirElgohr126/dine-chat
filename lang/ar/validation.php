...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف فقط بترميز أحادي البايت ورموزًا.',
    ...
    'confirmed' => 'لا تتطابق تأكيد حقل :attribute.',
    'current_password' => 'كلمة المرور غير صحيحة.',
    'date' => 'يجب أن يكون حقل :attribute تاريخًا صالحًا.',
    'date_equals' => 'يجب أن يكون حقل :attribute تاريخًا يساوي :date.',
    'date_format' => 'يجب أن يتناسب حقل :attribute مع الشكل :format.',
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute المُدخل تم التعرف عليه في تسريب بيانات. يرجى اختيار :attribute آخر.',
    ],
    ...
    'uppercase' => 'يجب أن يكون حقل :attribute في الأحرف الكبيرة.',
