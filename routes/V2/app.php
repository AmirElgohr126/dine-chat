...
use App\Http\Controllers\V2\App\About\AboutController;
use App\Http\Controllers\V2\App\Auth\LogoutController;
use App\Http\Controllers\V2\App\Chat\MessageController;
use App\Http\Controllers\V2\App\Auth\RegisterController;
use App\Http\Controllers\V2\App\Games\XOgame\XoController;
use App\Http\Controllers\V2\App\Profile\ProfileController;
use App\Http\Controllers\V2\App\Auth\VerificationController;
use App\Http\Controllers\V2\App\Settings\SettingsController;
use App\Http\Controllers\V2\App\Ratings\FoodRatingController;
use App\Http\Controllers\V2\App\Restaurant\RestaurantController;
use App\Http\Controllers\V2\App\Ratings\RestaurantRatingController;
use App\Http\Controllers\V1\App\ContactsList\ContactsListController;
use App\Http\Controllers\V2\App\Notifications\NotificationController;
use App\Http\Controllers\V2\App\Restaurant\GetMapsOfRestaurantController;
