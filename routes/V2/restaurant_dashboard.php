...
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\Foods\FoodController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\Assest\RestaurantAssest;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\Foods\FoodMenuController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\Tickets\TicketsController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\User\Profile\GetInfoController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\Statistics\StatisticsController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\User\Auth\LoginRestaurantController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\Notifications\NotificationController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\User\Auth\LogoutRestaurantController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\User\Profile\ProfileRestaurantController;
use App\Http\Controllers\V2\Dashboards\DashboardRestaurant\User\Auth\ResetPasswordRestaurantController;
